...
df_train_txt = df['image_id_worm'].iloc[:df.shape[0]*70//100]
df_val_txt = df['image_id_worm'].iloc[df.shape[0]*70//100:]

df_train_txt["image_id_worm"] = df_train_txt["image_id_worm"].apply(lambda x: "images/"+x)
df_val_txt["image_id_worm"] = df_val_txt["image_id_worm"].apply(lambda x: "images/"+x)
